...
![scheletro del calcolatore](../assets/focus_mem.svg)     Conosce i dati salvati nei propri indirizzi sottoforma di 0 e 1, ma non ne sa il significato

![scheletro del bus](../assets/focus_bus.svg)
